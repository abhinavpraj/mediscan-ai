        ...
        <Card>
          <CardHeader>
            ...
            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
              Useful for demos when you want instant offline extraction without
              a file.
            </p>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <Step
              ...
              title="Privacy first"
              text="No cloud APIs, no external inference, local SQLite only."
              tone="green"
            />
            <Step
              icon={<FileJson size={18} />}
              title="Structured output"
              text="OCR text becomes validated JSON for downstream systems."
              tone="blue"
            />
            <Step
              icon={<Bot size={18} />}
              title="CPU optimized"
              text="Deterministic extraction works immediately; local GGUF model can enrich results."
              tone="cyan"
            />
          </CardContent>
        </Card>
