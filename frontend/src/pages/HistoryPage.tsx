      ...
      <CardContent>
        {ordered.length === 0 ? (
          <EmptyState
            ...
            description="Uploaded reports and manual text extractions will appear here after processing."
          />
        ) : (
                      ...
                      <div className="min-w-0">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <Badge tone={risky ? "red" : "green"}>
                            {risky ? "Review" : "Complete"}
                          </Badge>
                        </div>
                        <p className="mt-1 flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
                          <FileText size={15} /> {report.report_type} from{" "}
                          {report.source_filename || "manual entry"}
                        </p>
